...
class koneksi{
   ...
   function __construct(){
       $this->koneksi=mysqli_connect("localhost","root","","db_pelatihan1");
   ...
   function get_dosen(){
	...
	function update_jadwal($ruang,$waktu){
		$this->koneksi->query("UPDATE tbl_ruang set ruang='$ruang', waktu='$waktu'");
		return true;
	}
